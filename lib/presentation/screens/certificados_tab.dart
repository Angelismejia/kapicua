...
class _CertificadosTabState extends State<CertificadosTab> {
  ...
  void initState() {
    ...
    final overridesRepo = context.read<MonthlyOverrideRepository>();
    _allOverridesStream = overridesRepo.watchAllMonthlyOverrides();
    _overrideStream = overridesRepo.watchMonthlyOverride(_selectedMonth);
  }

  void _changeMonth(DateTime month) {
    setState(() {
      _selectedMonth = month;
      _overrideStream = context
          .read<MonthlyOverrideRepository>()
          .watchMonthlyOverride(month);
    });
  }

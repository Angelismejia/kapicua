...
class _HomeTabState extends State<HomeTab> {
  ...
  void initState() {
    ...
    _activeGamesStream = context.read<GameRepository>().watchActiveGames();
    _statEntriesStream = context.read<StatsRepository>().watchAllStatEntries();
  ...
  List<_Notification> _buildNotifications(
    ...
    final creationTime = auth.currentUser?.creationTime;
